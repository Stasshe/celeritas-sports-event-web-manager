...
- **レスポンシブなトーナメント表**: PCは全体を静的表示し、スマートフォンは表示枠内のドラッグ移動・ピンチ拡大縮小に対応。公開画面は試合カード上からもドラッグ可能
...
- **ブラケット操作**: PCは静的表示。スマートフォンの公開画面は試合カードを含む表示枠内のドラッグ移動・ピンチ拡大縮小、管理画面は背景操作と試合カードのタップ編集に対応
